<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../../../data/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../../data/'; // absolute or relative from this script path, required.
