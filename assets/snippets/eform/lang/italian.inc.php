...
$_lang["ef_invalid_number"] = " non � un numero valido";
$_lang["ef_invalid_date"] = " non � una data valida";
$_lang["ef_invalid_email"] = " non � un indirizzo email valido";
$_lang["ef_upload_exceeded"] = " � stato superato il limite massimo di caricamento dati.";
...
$_lang["ef_failed_eval"] = "Il valore non � stato convalidato";
$_lang["ef_failed_ereg"] = "Il valore non � stato convalidato";
$_lang["ef_failed_upload"] = "Tipo di documento errato.";
$_lang["ef_error_validation_rule"] = "Regola di convalida non riconosciuta";
$_lang["ef_tamper_attempt"] = "� stato rilevato un tentativo di manomissione!";
$_lang["ef_error_formid"] = "Numero ID o nome del modulo non valido.";
$_lang["ef_debug_info"] = "Informazione di debug: ";
$_lang["ef_is_own_id"] = "<span class=\"ef-form-error\">Il template del modulo � stato impostato sull'id di una pagina contenente una chiamata a uno snippet! Non � possibile avere il modulo e una chiamata a uno snippet nello stesso documento.</span> id=";
...
$_lang['ef_mail_abuse_message'] = '<p>Un modulo presente sul vostro sito potrebbe essere stato soggetto ad un tentativo di abuso email. I dettagli dei valori inviati sono riportati qui in basso. Il testo sospetto � stato inserito tra i tag \[..]\.  </p>';
$_lang['ef_mail_abuse_error'] = '<strong>Nel modulo sono state rilevate delle voci non valide o insicure</strong>.';
$_lang['ef_eval_deprecated'] = "La regola #EVAL � sconsigliata e potrebbe non funzionare nelle versioni future. Vi preghiamo di usare al suo posto #FUNCTION.";
?>