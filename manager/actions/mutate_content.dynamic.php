...
<div id="actions">
      <ul class="actionButtons">
          ...
          <?php $adress = substr($site_url, 0, strlen($site_url)-1); ?>
          <li id="Button5"><a target="_blank" href="http://questoria.ru<?= $modx->makeUrl($id); ?>"><!-- onclick="window.open(' ','previeWin');"--><img alt="icons_preview_resource" src="<?php echo $_style["icons_preview_resource"] ?>" /> <?php echo $_lang['preview']?></a></li>
      </ul>
</div>
